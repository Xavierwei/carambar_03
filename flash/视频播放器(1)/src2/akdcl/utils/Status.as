package akdcl.utils{
	...
	public class Status extends Sprite {
		...
		/**
		 *{ bg: 0x202020, fps: 0xC0C0C0, ms: 0x505050, mem: 0x707070, memmax: 0xA0A0A0 }
		 */
		public function Status(_theme:Object = null):void {
			if (_theme){
				if (_theme.bg != null)
					theme.bg = _theme.bg;
				if (_theme.fps != null)
			...
			style.setStyle("xml", {fontSize: '9px', fontFamily: '_sans', leading: '-3px'});
			...
			rectangle = new Rectangle(WIDTH - 1, 0, 1, HEIGHT - graph.y);
		...
		private function init(e:Event):void {
			...
			graph.bitmapData = new BitmapData(WIDTH, HEIGHT - graph.y, false, theme.bg);
			addChild(graph);
