...
package{
	...
	public class Player extends MovieClip {
		...
		private function frame3():void{
			...
			//mediaPlayer.bufferTime=30;
			
			//player1~6
			//mediaPlayer.init(LayoutMode.STAND_ALONE,40,0,,null);
			
			//player7
			//mediaPlayer.scaleMode=ScaleMode.STRETCH;
			//mediaPlayer.init(LayoutMode.STAND_ALONE,0,25,null);
			//mediaPlayer.init(LayoutMode.STAND_ALONE,0,0,null);
			mediaPlayer.init(LayoutMode.STAND_ALONE,0,0,null,false);
			
			//mediaPlayer.source="http://zero.flashwing.net/my/16.flv";
			
			mediaPlayer.source=mediaPlayer.source;//不然 autoplay 不起作用
		...
		private function _play(...args):void{
			if(flag){
				...
				flag=true;
				if(mediaPlayer.startImageLoader){
					mediaPlayer.startImageLoader.visible=false;
				}
