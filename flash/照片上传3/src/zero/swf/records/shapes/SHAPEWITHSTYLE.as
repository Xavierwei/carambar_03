	...
	public class SHAPEWITHSTYLE{
				...
				if(first6Bits){
					switch(first6Bits&0x30){
						case 0x30://110000
							...
							var NumBits:int=(first6Bits&0x0f)+2;
						...
						default:
							...
							if(first6Bits&0x10){//StateNewStyles							//010000
								...
								if(currFillStyleCount){
									...
									for(var currStyleI:int=0;currStyleI<currFillStyleCount;currStyleI++){
		...
		public function toData(_toDataOptions:Object):ByteArray{
			...
			if(LineStyle2V||LineStyleV){
				if(LineStyle2V){
					var LineStyleCount:int=LineStyle2V.length;
				}else{
			...
			for each(var calNumBitsShapeRecord:SHAPERECORD in ShapeRecordV){
