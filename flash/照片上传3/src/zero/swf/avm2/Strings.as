...
package zero.swf.avm2{
	...
	public class Strings{
		...
		public static function write(data:ByteArray,stringV:Vector.<String>,stringBytesArr:Array):void{
			...
			if(stringV){
				...
				if(count>1){
					...
					for(var i:int=1;i<count;i++){
						...
						if(stringBytesArr&&stringBytesArr[i]){//20131205
							data.position=offset;
							data.writeBytes(stringBytesArr[i]);
							offset+=stringBytesArr[i].length;
						}else{
							if(string){
