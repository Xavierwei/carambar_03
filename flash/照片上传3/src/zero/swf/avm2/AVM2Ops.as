...
package zero.swf.avm2{
	...
	public class AVM2Ops{
		...
		public static const getouterscope:int=103;//0x67			//20131206 F:\airs\program files2\SWFXML\tests\myencrypt 中首次发现使用
...
init({
	...
	getouterscope:	"u8						|scopeid					|… => …, scope															|getouterscope scopeid=0",//0x67
