			...
			switch(type){
				...
				case "ZWS"://20120517
					...
					if(hasLZMA){
						...
						var uncompressed_size0:int=(swfData[4]|(swfData[5]<<8)|(swfData[6]<<16)|(swfData[7]<<24));
						for(var d:int=8;d<=16;d+=8){
							var uncompressed_size:int=uncompressed_size0-d;//带“end marker”的减8，不带“end marker”的减16 //20140123
