package com.makeit.utils {
  ...
  public class NumberUtilities {
    ...
    public static function round(nNumber:Number, nRoundToInterval:Number = 1):Number {
     ...
     public static function cint(nNumber:Number, nRoundToInterval:Number = 1):Number {
      // Return the result
      var num:int=nNumber / nRoundToInterval;
      var c:int=1/nRoundToInterval;
      return  num/c;//* nRoundToInterval;
    }
