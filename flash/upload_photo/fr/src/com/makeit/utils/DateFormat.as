package com.makeit.utils {
	...
	public class DateFormat {
		...
		public static function formatSeconds(nTotalSeconds:Number):String {
		    var nfFormatter:com.makeit.utils.NumberFormat = new com.makeit.utils.NumberFormat("00");
		    ...
		    for(var i:Number = 0; i < aMask.length; i++) {
		      switch (aMask[i].element) {
		        ...
		        case "d":
		          ...
		          break;
		        case "D":
		          aFormatted.push(com.makeit.utils.DateFormat.DAYS_ABBREVIATED[dDate.getDay()]);
		          break;
		        case "F":
		          aFormatted.push(com.makeit.utils.DateFormat.MONTHS[dDate.getMonth()]);
		          break;
		        case "g":
		        ...
		        case "j":
		          ...
		          break;
		        case "l":
		          aFormatted.push(com.makeit.utils.DateFormat.DAYS[dDate.getDay()]);
		          break;
		        case "m":
		          var nfFormatter:com.makeit.utils.NumberFormat = new com.makeit.utils.NumberFormat("00");
		          ...
		          break;
		        case "M":
		          aFormatted.push(com.makeit.utils.DateFormat.MONTHS_ABBREVIATED[dDate.getMonth()]);
		          break;
		        case "n":
		        ...
		        case "s":
		          ...
		          break;
		        case "t":
		          aFormatted.push(com.makeit.utils.DateFormat.DAYSINMONTH[dDate.getMonth()]);
		          break;
		        case "w":
		    ...
		    for(var i:Number = 0; i < aMask.length; i++) {
		      ...
		      switch (aMask[i].element) {
		        ...
		        case "F":
		          ...
		          for(var j:Number = 0; j < com.makeit.utils.DateFormat.MONTHS.length; j++) {
		            if(sMonth == com.makeit.utils.DateFormat.MONTHS[j].toLowerCase()) {
		              dDate.setMonth(j);
		              break; 
		            }
		          }
		        ...
		        case "M":
		          ...
		          for(var j:Number = 0; j < com.makeit.utils.DateFormat.MONTHS_ABBREVIATED.length; j++) {
		            if(com.makeit.utils.DateFormat.MONTHS_ABBREVIATED[j].toLowerCase() == sMonth) {
		              dDate.setMonth(j);
		              break;
		            }
		          }
