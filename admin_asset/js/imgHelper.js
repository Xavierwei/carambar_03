!(function( factory ){
    ...
    function initialize( $dom ){
        ...
        var mousedown = false;
        var perScale = 1.1;
        $('.zoomout-btn,.zoomin-btn').bind( supportTouch ? 'touchstart' : 'mousedown' ,function(){
            mousedown = true;
            var isZoomOut = $(this).hasClass('zoomout-btn');
        ...
        .bind( supportTouch ? 'touchend' : 'mouseup' , function(){
            ...
            if( runAnimate ){
              ...
              imgMgr.scale( $(this).hasClass('zoomout-btn') ? perScale : 1 / perScale , _wrapWidth / 2 , _wrapHeight / 2 );
            }
        } );
    }
